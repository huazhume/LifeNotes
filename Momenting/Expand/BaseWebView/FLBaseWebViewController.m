...
- (void)setNavigationTitle:(NSString *)navigationTitle
{
    ...
    self.navigationView.titleLabel.text = navigationTitle;
}

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.navigationView.frame = CGRectMake(0, 0, SCREEN_WIDTH, 55 + iPhoneTopMargin);
    self.navigationView.delegate = self;
    //        _navigationView.backgroundColor = [UIColor whiteColor];
    self.navigationView.rightTitle = @"";
    self.navigationView.navigationTitle = _navigationTitle;
